...
class MtExcelHelperBase
{
   ...
   * @throws Exception
   */
  public static function dateValue($excelValue): ?MtDateTime
  {
    $datetime = null;
    ...
    if($excelValue)
    {
      if(is_numeric($excelValue))
      {
        try
        {
          $datetime = Date::excelToDateTimeObject($excelValue, MtDateTime::getDefaultTimezone());
        } catch (Exception $ex)
        {
          $datetime = null;
        }
      ...
      if($datetime)
      {
        $datetime = new MtDateTime($datetime);
      }
      else
      {
        try
        {
          $datetime = new MtDateTime($excelValue);
        } catch (Exception $ex)
        {
          $datetime = null;
        }
