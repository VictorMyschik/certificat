	...
	<div id="right-panel" class="right-panel">
		...
		<div class="content mt-3">
			<div class="animated fadeIn">
						...
						<h5>Новое ообщение
							{!!  \App\Http\Controllers\Forms\MrForm::loadForm('user_message_edit', 'MrMessageEditForm', ['id' => '0'], 'Новое') !!}
						</h5>
									...
									<tr>
										<td>
											<div class="d-md-inline-flex">
												<div class="col-md-6 col-sm-12 mr-middle border">
													{!!  \App\Http\Controllers\Forms\MrForm::loadForm('user_message_edit', 'MrMessageEditForm', ['id' =>  $message->id() ],'р') !!}
													<b>{{ $message->getTitle() }}</b>
												</div>
												<div class="col-md-2  col-sm-12 mr-middle borderl">{{ $message->getDate()->format('d.m.Y H:i') }}</div>
												<div class="col-md-2  col-sm-12 mr-middle border">
													{{ $message->getDateReade()?$message->getDateReade()->format('d.m.Y H:i'):null }}</div>
												<div class="col-md-2  col-sm-12 mr-middle border">
													{{ $message->getFromUser()?$message->getFromUser()->GetShortName():null }}
													<a href="/admin/message/{{ $message->id() }}/delete" class="mr-middle mr-color-red"
													   onclick="return confirm('Удалить сообщение?');"><button class="btn btn-danger btn-sm mr-border-radius-10">Удалить</button></a>
												</div>
											</div>
										</td>
									</tr>
