		...
		<div>
			...
			<div class=" col-md-4">
				...
				<div class="">
					...
					{!! \App\Http\Controllers\Forms\MrForm\FormBase::loadForm('user_delete', 'MrUserDeleteForm', [], 'удалить
					акаунт',['mr-sumbit-cancel']) !!}
				</div>

			</div>
		</div>

		<div> <h4>Пользователь</h4>
			<div class=" col-md-4">
				<div class="d-inline-flex ">
					{!! \App\Http\Controllers\Helpers\MrMessageHelper::GetMessage() !!}
					@foreach($errors->all() as $err)
