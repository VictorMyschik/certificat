  ...
  <div class="container">
    <div class="row justify-content-center">
      <div class="col-md-8">
        <div class="">
          <div class="card-body">
            <h5 class="mr-bold"> {{ __('mr-t.Регистрация') }} <span class="fa-pull-right"><i class="fa fa-info-circle mr-color-green"></i>Все поля обязательны для заполнения</span></h5>
            <hr>
            ...
            <form method="POST" action="{{ route('register') }}">
              ...
              <div class="form-group row">
                ...
                <div class="col-md-6">
                  <input id="office" type="text" {{ isset($office)?'readonly':null }} class="form-control @error('office') is-invalid @enderror" name="office"
              ...
              <div class="form-group row">
                ...
                <div class="col-md-6">
                  <input id="email" type="email" {{ isset($email)?'readonly':null }} class="form-control @error('email') is-invalid @enderror" name="email"
              ...
              <div class="form-group row">
                ...
                <div class="col-md-6">
                  {{ __('mr-t.Я согласен с') }} <a href="/policy" target="_blank">{{ __('mr-t.Политикой приватности') }}</a>,
